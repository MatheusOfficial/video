...
const kayıtlı = message.guild.roles.find(r => r.id === "771324163725721620"); // ERKEK ROLÜNÜN İDSİ
const kayıtlı2 = message.guild.roles.find(r => r.id === "771324163725721620"); // ERKEK ROLÜNÜN İDSİ
